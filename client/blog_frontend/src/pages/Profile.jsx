              ...
              <div className="flex flex-col md:flex-row items-center p-6">
                ...
                <div className="flex space-x-4 mt-4 md:mt-0">
                  <button
                    ...
                    className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 min-w-[80px]"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDelete(blog.id)}
                    className="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 min-w-[80px]"
                  >
                    Delete
                  </button>
                </div>
